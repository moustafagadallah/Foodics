...
var map = {
	"./login-verification-code/login-verification-code.module": [
	...
	"./pages/onlin-shopping/onlin-shopping.module": [
		"./src/app/pages/onlin-shopping/onlin-shopping.module.ts",
		"default~Home-tab3-module~Profile-tab1-module~Request-tab4-module~pages-onlin-shopping-onlin-shopping~93d9100c",
		"pages-onlin-shopping-onlin-shopping-module"
	],
	"./pages/personal-informations/personal-informations.module": [
		"./src/app/pages/personal-informations/personal-informations.module.ts",
		"default~Home-tab3-module~Profile-tab1-module~Request-tab4-module~pages-onlin-shopping-onlin-shopping~93d9100c",
		"common",
		"pages-personal-informations-personal-informations-module"
	],
	"./pages/request-details/request-details.module": [
		...
		"default~Home-tab3-module~Profile-tab1-module~Request-tab4-module~pages-onlin-shopping-onlin-shopping~93d9100c",
		"default~Request-tab4-module~pages-request-details-request-details-module",
		"common",
		"pages-request-details-request-details-module"
	],
	...
	"./pages/userService/profile/profile.module": [
		"./src/app/pages/userService/profile/profile.module.ts",
		"pages-userService-profile-profile-module"
	],
	"./pages/userService/serviceProviders/provided-details/provided-details.module": [
		"./src/app/pages/userService/serviceProviders/provided-details/provided-details.module.ts",
		"default~Home-tab3-module~Profile-tab1-module~Request-tab4-module~pages-onlin-shopping-onlin-shopping~93d9100c",
		"common",
		"pages-userService-serviceProviders-provided-details-provided-details-module"
	],
	"./pages/userService/serviceProviders/provided-services/provided-services.module": [
		"./src/app/pages/userService/serviceProviders/provided-services/provided-services.module.ts",
		"default~Home-tab3-module~Profile-tab1-module~Request-tab4-module~pages-onlin-shopping-onlin-shopping~93d9100c",
		"pages-userService-serviceProviders-provided-services-provided-services-module"
	],
	"./pages/userService/serviceProviders/service-provider/service-provider.module": [
...
/* harmony import */ var _services_DataShare_data_resolve_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./services/DataShare/data-resolve.service */ "./src/app/services/DataShare/data-resolve.service.ts");
...
const routes = [
    ...
    { path: 'getintouch', loadChildren: './pages/get-in-touch/get-in-touch.module#GetInTouchPageModule' },
    {
    ...
    { path: 'medical-history', loadChildren: './pages/medical-history/medical-history.module#MedicalHistoryPageModule' },
    { path: 'request-details', loadChildren: './pages/request-details/request-details.module#RequestDetailsPageModule' },
    { path: 'service-provider', loadChildren: './pages/userService/serviceProviders/service-provider/service-provider.module#ServiceProviderPageModule' },
    { path: 'provided-services', loadChildren: './pages/userService/serviceProviders/provided-services/provided-services.module#ProvidedServicesPageModule' },
    { path: 'profile', loadChildren: './pages/userService/profile/profile.module#ProfilePageModule' },
    { path: 'provided-details', loadChildren: './pages/userService/serviceProviders/provided-details/provided-details.module#ProvidedDetailsPageModule' },
    { path: 'onlin-shopping', loadChildren: './pages/onlin-shopping/onlin-shopping.module#OnlinShoppingPageModule' },
...
/* harmony import */ var _enums_filesPath__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./enums/filesPath */ "./src/app/enums/filesPath.ts");
/* harmony import */ var _services_TempDataDistributor_TempDataDistributor__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./services/TempDataDistributor/TempDataDistributor */ "./src/app/services/TempDataDistributor/TempDataDistributor.ts");
/* harmony import */ var _services_login_login__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./services/login/login */ "./src/app/services/login/login.ts");
/* harmony import */ var _enums_pageName__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./enums/pageName */ "./src/app/enums/pageName.ts");
/* harmony import */ var _components_lang_change_lang_change_page__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./components/lang-change/lang-change.page */ "./src/app/components/lang-change/lang-change.page.ts");
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, _translate, storage, router, _loading, _temDataDistributor, _login, document, langChange) {
        ...
        this.appMenu = [
            { title: 'Request', url: '/tabs/tab4', pageName: _enums_pageName__WEBPACK_IMPORTED_MODULE_13__["pageName"].REQUEST, icon: 'basket' },
            { title: 'Profile', url: '/tabs/tab1', pageName: _enums_pageName__WEBPACK_IMPORTED_MODULE_13__["pageName"].PROFILE, icon: 'person' },
            { title: 'Chat with us', url: '/tabs/chat', pageName: _enums_pageName__WEBPACK_IMPORTED_MODULE_13__["pageName"].CHAT, icon: 'chatboxes' },
            { title: 'Get in touch', url: '/tabs/getintouch', pageName: _enums_pageName__WEBPACK_IMPORTED_MODULE_13__["pageName"].GETINTOUCH, icon: 'list' },
            { title: 'About', url: '/tabs/about-us', pageName: _enums_pageName__WEBPACK_IMPORTED_MODULE_13__["pageName"].ABOUT, icon: 'information-circle' },
            { title: 'Lang Change', url: 'langChange', pageName: 'lang-change', icon: 'globe' },
        ];
        this.initializeApp();
    }
    initializeApp() {
        this.authState().then(data => {
            console.log(data);
            this._temDataDistributor.authState.subscribe(isAuth => {
                console.log(isAuth);
                this.isLogin = isAuth;
            });
        });
    ...
    _initTranslate() {
        this._temDataDistributor.profileStoredImage.subscribe(sideMenuImg => {
            this.sideMenuImg = sideMenuImg;
        });
        this.sideMenuImg = (window.localStorage.getItem("imgURL")) ? window.localStorage.getItem("imgURL") : _enums_filesPath__WEBPACK_IMPORTED_MODULE_10__["filesPath"].DEFAULT_PROFILE_IMAGE_URL;
        // Set the default language for translation strings, and the current language.
        console.log(window.localStorage.getItem('lang'));
        if (window.localStorage.getItem('lang')) {
            let default_Lang = window.localStorage.getItem('lang');
        ...
        if (window.localStorage.getItem('lang') == 'ar') {
            ...
            this.appMenu[5].title = 'تغير اللغة';
            // this.appMenu[5].title = 'الاعدادات';
    ...
    authState() {
        let promise = new Promise((resolve, reject) => {
            this._login.GetCheckAuthorization().subscribe(authState => {
                console.log(authState);
                this._temDataDistributor.authState.next(true);
                resolve(true);
            }, err => {
                console.log(err);
                this._temDataDistributor.authState.next(false);
                reject(false);
            });
        });
        return promise;
...
AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"],
        ...
        _services_TempDataDistributor_TempDataDistributor__WEBPACK_IMPORTED_MODULE_11__["TempDataDistributorService"],
        _services_login_login__WEBPACK_IMPORTED_MODULE_12__["LoginService"],
        Document,
...
/* harmony import */ var _interceptor_Index_interceptor_index__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./interceptor/Index/interceptor.index */ "./src/app/interceptor/Index/interceptor.index.ts");
...
/* harmony import */ var _components_lang_change_lang_change_module__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./components/lang-change/lang-change.module */ "./src/app/components/lang-change/lang-change.module.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        entryComponents: [],
        imports: [
            primeng_primeng__WEBPACK_IMPORTED_MODULE_15__["FileUploadModule"],
            ...
            _components_lang_change_lang_change_module__WEBPACK_IMPORTED_MODULE_21__["LangChangePageModule"],
        ],
        providers: [
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LangChangePageModule", function() { return LangChangePageModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm2015/common.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/fesm5.js");
/* harmony import */ var _lang_change_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./lang-change.page */ "./src/app/components/lang-change/lang-change.page.ts");
...
let LangChangePageModule = class LangChangePageModule {
};
LangChangePageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LangChangeComponent", function() { return LangChangeComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
/* harmony import */ var src_app_services_TempDataDistributor_TempDataDistributor__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/services/TempDataDistributor/TempDataDistributor */ "./src/app/services/TempDataDistributor/TempDataDistributor.ts");
...
let LangChangeComponent = class LangChangeComponent {
    constructor(_setting, _translate, splashScreen, document, platform, modalController, _tempData) {
...
LangChangeComponent.ctorParameters = () => [
...
], LangChangeComponent.prototype, "onLangChange", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Boolean)
], LangChangeComponent.prototype, "isFromSideMenu", void 0);
LangChangeComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'lang-change',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./lang-change.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/lang-change/lang-change.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./lang-change.page.scss */ "./src/app/components/lang-change/lang-change.page.scss")).default]
    }),
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_app_services_Settings_Settings__WEBPACK_IMPORTED_MODULE_2__["SettingsService"],
        ...
        src_app_services_TempDataDistributor_TempDataDistributor__WEBPACK_IMPORTED_MODULE_7__["TempDataDistributorService"]])
], LangChangeComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "filesPath", function() { return filesPath; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
/* harmony import */ var _interceptor_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../interceptor.service */ "./src/app/interceptor/interceptor.service.ts");
/* harmony import */ var _header_incepter__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../header.incepter */ "./src/app/interceptor/header.incepter.ts");
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _services_TempDataDistributor_TempDataDistributor__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../services/TempDataDistributor/TempDataDistributor */ "./src/app/services/TempDataDistributor/TempDataDistributor.ts");
/* harmony import */ var _services_login_login__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../services/login/login */ "./src/app/services/login/login.ts");
...
let HeaderInterceptor = class HeaderInterceptor {
    constructor(router, _tempData, _login) {
        this.router = router;
        this._tempData = _tempData;
        this._login = _login;
    }
...
HeaderInterceptor = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"],
        _services_TempDataDistributor_TempDataDistributor__WEBPACK_IMPORTED_MODULE_4__["TempDataDistributorService"],
        _services_login_login__WEBPACK_IMPORTED_MODULE_5__["LoginService"]])
], HeaderInterceptor);
...
/* harmony import */ var _services_TempDataDistributor_TempDataDistributor__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../services/TempDataDistributor/TempDataDistributor */ "./src/app/services/TempDataDistributor/TempDataDistributor.ts");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/fesm5.js");
...
let httpRequestInterceptor = class httpRequestInterceptor {
    constructor(router, _tempData, toastController) {
        this.router = router;
        this._tempData = _tempData;
...
httpRequestInterceptor = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"],
        _services_TempDataDistributor_TempDataDistributor__WEBPACK_IMPORTED_MODULE_5__["TempDataDistributorService"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DataResolveService", function() { return DataResolveService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _data_share_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./data-share.service */ "./src/app/services/DataShare/data-share.service.ts");



let DataResolveService = class DataResolveService {
...
DataResolveService.ctorParameters = () => [
    { type: _data_share_service__WEBPACK_IMPORTED_MODULE_2__["DataShareService"] }
];
DataResolveService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_data_share_service__WEBPACK_IMPORTED_MODULE_2__["DataShareService"]])
], DataResolveService);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EvaluateModle", function() { return EvaluateModle; });
...
let SettingsService = class SettingsService {
   ...
   */
    getAllSettings() {
        let url_ = src_app_enums_baseUrl__WEBPACK_IMPORTED_MODULE_3__["BaseUrl"].baseUrl + "/api/services/app/HostSettings/GetAllSettings";
        url_ = url_.replace(/[?&]$/, "");
        return this.http.get(url_);
    }
    GetCurrentUserProfileForEdit() {
        let url_ = src_app_enums_baseUrl__WEBPACK_IMPORTED_MODULE_3__["BaseUrl"].baseUrl + "/api/services/app/Profile/GetCurrentUserProfileForEdit";
        url_ = url_.replace(/[?&]$/, "");
        return this.http.get(url_);
    }
    getChangeLanguage(langType) {
        let url_ = src_app_enums_baseUrl__WEBPACK_IMPORTED_MODULE_3__["BaseUrl"].baseUrl + "/api/services/app/Profile/ChangeLanguage";
        const input = new ChangeUserLanguageDto();
        input.languageName = langType;
        url_ = url_.replace(/[?&]$/, "");
        return this.http.post(url_, input);
    }
    evaluateRequest(evaluateModle) {
        let url_ = src_app_enums_baseUrl__WEBPACK_IMPORTED_MODULE_3__["BaseUrl"].baseUrl + "/api/services/app/Request/EvaluateRequest";
        const input = new EvaluateModle();
    ...
    getCurrentUserLanguage() {
        let url_ = src_app_enums_baseUrl__WEBPACK_IMPORTED_MODULE_3__["BaseUrl"].baseUrl + "/api/services/app/Account/GetCurrentUserLanguage";
        url_ = url_.replace(/[?&]$/, "");
        return this.http.get(url_);
    }
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TempDataDistributorService", function() { return TempDataDistributorService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm2015/index.js");
/* harmony import */ var src_app_enums_filesPath__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/enums/filesPath */ "./src/app/enums/filesPath.ts");




let TempDataDistributorService = class TempDataDistributorService {
    constructor() {
    ...
    getStoredImage() {
        if (this.imgURL) {
            ...
            return src_app_enums_filesPath__WEBPACK_IMPORTED_MODULE_3__["filesPath"].DEFAULT_PROFILE_IMAGE_URL;
    }
    newImage(imgURL) {
...
TempDataDistributorService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [])
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MobileRegisterInput", function() { return MobileRegisterInput; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MobileLoginOrRegisterOutput", function() { return MobileLoginOrRegisterOutput; });
...
class MobileLoginOrRegisterOutput {
    constructor(result) {
...
let LoginService = class LoginService {
    ...
    loginWithNationalIdAndMobile(mobileLoginInput) {
        let url_ = src_app_enums_baseUrl__WEBPACK_IMPORTED_MODULE_3__["BaseUrl"].baseUrl + "/api/services/app/Account/LoginWithNationalIdAndMobile";
   ...
   */
    authenticate(model) {
        let url_ = src_app_enums_baseUrl__WEBPACK_IMPORTED_MODULE_3__["BaseUrl"].baseUrl + "/api/TokenAuth/Authenticate";
        url_ = url_.replace(/[?&]$/, "");
        return this.http.post(url_, model);
    }
    registerMobileUser(model) {
        let url_ = src_app_enums_baseUrl__WEBPACK_IMPORTED_MODULE_3__["BaseUrl"].baseUrl + "/api/services/app/Account/RegisterMobileUser";
        return this.http.post(url_, model);
    }
    GetCheckAuthorization() {
        let url_ = src_app_enums_baseUrl__WEBPACK_IMPORTED_MODULE_3__["BaseUrl"].baseUrl + "/api/services/app/Account/GetCheckAuthorization";
        return this.http.get(url_);
    }
};
...
module.exports = __webpack_require__(/*! D:\work\project\SHCT\src\main.ts */"./src/main.ts");
