...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["login-login-module"], {
  ...
  /***/
  function srcAppEnumsAlertMessageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "LoginAlertMessage", function () {
      return LoginAlertMessage;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "RegisterAlertMessage", function () {
      return RegisterAlertMessage;
    });
    /* harmony import */
  ...
  function srcAppLoginLoginPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_Lookup_LookUps__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../services/Lookup/LookUps */
    "./src/app/services/Lookup/LookUps.ts");
    /* harmony import */


    var _services_login_login__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    ...
    var _services_DataShare_data_share_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ../services/DataShare/data-share.service */
    ...
    var _enums_AlertMessage__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ../enums/AlertMessage */
    "./src/app/enums/AlertMessage.ts");

    var LoginPage = /*#__PURE__*/function () {
      function LoginPage(_translate, _lookUp, _login, router, _dataShare, _loading, alertController, navctrl) {
        ...
        this.navctrl = navctrl; //isEditable      : boolean = false;
      ...
      _createClass(LoginPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.setupForm(); // this.loadNationalities();
          //this.loadCountries();
        } //#region  Validation
        ...
        value: function login() {
          ...
          this._login.loginWithNationalIdAndMobile(loginInput).subscribe(function (data) {
            _this._loading.dismiss();

            _this.titleLoginMessage = _this._translate.currentLang == 'ar' ? _enums_AlertMessage__WEBPACK_IMPORTED_MODULE_10__["LoginAlertMessage"].title_ar : _enums_AlertMessage__WEBPACK_IMPORTED_MODULE_10__["LoginAlertMessage"].title_en;
            _this.messageLoginFaild = _this._translate.currentLang == 'ar' ? _enums_AlertMessage__WEBPACK_IMPORTED_MODULE_10__["LoginAlertMessage"].messageLoginFaild_ar : _enums_AlertMessage__WEBPACK_IMPORTED_MODULE_10__["LoginAlertMessage"].messageLoginFaild_en;
            console.log(data);

            if (data.result.status == 1) {
              _this._dataShare.setData("loginInfo", _this.id);

              _this.router.navigateByUrl('/login-verification-code/loginInfo');
            } else _this.presentAlert(_this.titleLoginMessage, _this.messageLoginFaild);
          }, function (error) {
            _this._loading.dismiss();

            _this.presentAlert(_this.titleLoginMessage, _this.messageLoginFaild);
        ...
        value: function slidNext() {
          ...
          this.slides.getActiveIndex().then(function (Index) {
            ...
            _this2.lastSlide = Index === 2 ? true : false;
          });
        }
      }, {
        key: "slidPrev",
        value: function slidPrev() {
          ...
          this.slides.getActiveIndex().then(function (Index) {
            console.log(Index);
            _this3.slideIndexNumber = Index;
            _this3.lastSlide = Index === 2 ? true : false;
          });
        } //#region LookUps
        // loadNationalities() {
        ...
        key: "districtsSelected",
        value: function districtsSelected(district) {
        ...
        value: function registerMobileUser() {
          var _this4 = this;
          ...
          var user = new _services_login_login__WEBPACK_IMPORTED_MODULE_6__["MobileRegisterInput"](this.newUser);
          console.log(this.newUser);

          this._login.registerMobileUser(user).subscribe(function (data) {
            _this4._loading.dismiss();

            console.log(data);

            if (data.result.status == 1) {
              _this4._dataShare.setData("loginInfo", _this4.UserName);

              _this4.router.navigateByUrl('/login-verification-code/loginInfo');

              _this4.mobileRegisterOutput = data.result;
              console.log(_this4.mobileRegisterOutput);
            } else _this4.presentAlert("", data.result.message);
          }, function (error) {
            _this4._loading.dismiss();

            console.log(error);
            _this4.titleRegisterMessage = _this4._translate.currentLang == 'ar' ? _enums_AlertMessage__WEBPACK_IMPORTED_MODULE_10__["RegisterAlertMessage"].title_ar : _enums_AlertMessage__WEBPACK_IMPORTED_MODULE_10__["RegisterAlertMessage"].title_en;
            _this4.messageRegisterEmailInvalid = _this4._translate.currentLang == 'ar' ? _enums_AlertMessage__WEBPACK_IMPORTED_MODULE_10__["RegisterAlertMessage"].messageRegisterEmailInvalid_ar : _enums_AlertMessage__WEBPACK_IMPORTED_MODULE_10__["RegisterAlertMessage"].messageRegisterEmailInvalid_en;
            _this4.messageRegisterUserNameInvalid = _this4._translate.currentLang == 'ar' ? _enums_AlertMessage__WEBPACK_IMPORTED_MODULE_10__["RegisterAlertMessage"].messageRegisterUserNameInvalid_ar : _enums_AlertMessage__WEBPACK_IMPORTED_MODULE_10__["RegisterAlertMessage"].messageRegisterUserNameInvalid_en;
            if (error.error.error.validationErrors) _this4.presentAlert(_this4.titleRegisterMessage, _this4.messageRegisterEmailInvalid);else _this4.presentAlert(_this4.titleRegisterMessage, _this4.messageRegisterUserNameInvalid);
          });
        }
      }, {
        key: "presentAlert",
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ngx_translate_core__WEBPACK_IMPORTED_MODULE_4__["TranslateService"], _services_Lookup_LookUps__WEBPACK_IMPORTED_MODULE_5__["LookUps"], _services_login_login__WEBPACK_IMPORTED_MODULE_6__["LoginService"], _angular_router__WEBPACK_IMPORTED_MODULE_7__["Router"], _services_DataShare_data_share_service__WEBPACK_IMPORTED_MODULE_8__["DataShareService"], _services_loading_loading_service__WEBPACK_IMPORTED_MODULE_9__["LoadingService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["AlertController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"]])], LoginPage);
    /***/
  }
}]);
