...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["Request-tab4-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppTabsRequestTab4PageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppServicesMainRequestMainRequestTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "MainRequestService", function () {
    ...
    var MainRequestService = /*#__PURE__*/function () {
      function MainRequestService(http) {
        _classCallCheck(this, MainRequestService);
      ...
      _createClass(MainRequestService, [{
        key: "getAll",
        value: function getAll(filter, providerId, userId, patientIds, requestStatusIds, sorting, skipCount, maxResultCount) {
          var url_ = src_app_enums_baseUrl__WEBPACK_IMPORTED_MODULE_3__["BaseUrl"].baseUrl + "/api/services/app/Request/GetAll?";
          if (filter !== undefined) url_ += "Filter=" + encodeURIComponent("" + filter) + "&";
          if (providerId !== undefined) url_ += "ProviderId=" + encodeURIComponent("" + providerId) + "&";
          if (userId !== undefined) url_ += "UserId=" + encodeURIComponent("" + userId) + "&";
          if (patientIds !== undefined) patientIds && patientIds.forEach(function (item) {
            url_ += "PatientIds=" + encodeURIComponent("" + item) + "&";
          });
          if (requestStatusIds !== undefined) requestStatusIds && requestStatusIds.forEach(function (item) {
            url_ += "RequestStatusIds=" + encodeURIComponent("" + item) + "&";
          });
    ...
    MainRequestService.ctorParameters = function () {
      return [{
        type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]
      }];
    };

    MainRequestService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]])], MainRequestService);
    /***/
  },
  ...
  /***/
  function srcAppTabsRequestTab4ModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var ionic4_star_rating__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ionic4-star-rating */
    ...
    "./src/app/components/components.module.ts"); //import { EvaluationsPage } from 'src/app/components/evaluations/evaluations.page';
    ...
    Tab4PageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_1__["IonicModule"], ionic4_rating__WEBPACK_IMPORTED_MODULE_7__["IonicRatingModule"], ionic4_star_rating__WEBPACK_IMPORTED_MODULE_8__["StarRatingModule"], angular_archwizard__WEBPACK_IMPORTED_MODULE_9__["ArchwizardModule"], src_app_components_components_module__WEBPACK_IMPORTED_MODULE_11__["CustomComponentsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild([{
        path: '',
  ...
  /***/
  function srcAppTabsRequestTab4PageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppTabsRequestTab4PageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_services_MainRequest_mainRequest__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! src/app/services/MainRequest/mainRequest */
    "./src/app/services/MainRequest/mainRequest.ts");
    /* harmony import */
    ...
    var src_app_components_evaluations_evaluations_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! src/app/components/evaluations/evaluations.component */
    "./src/app/components/evaluations/evaluations.component.ts");
    /* harmony import */


    var src_app_components_advanced_fiter_advanced_fiter_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! src/app/components/advanced-fiter/advanced-fiter.component */
    "./src/app/components/advanced-fiter/advanced-fiter.component.ts");
    /* harmony import */


    var src_app_enums_pageName__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! src/app/enums/pageName */
    "./src/app/enums/pageName.ts"); //import { IRequestServicesDto } from 'src/app/models/RequestDto/RequestServicesDto';


    var Tab4Page = /*#__PURE__*/function () {
      function Tab4Page(router, _Request, _loadCtrl, _dataShare, modalController) {
      ...
      _createClass(Tab4Page, [{
        ...
        value: function logRatingChange(rating) {
          console.log("changed rating: ", rating); // do your stuff
        }
      }, {
        key: "enterSecondStep",
        value: function enterSecondStep(enter) {
          console.log(enter);
        }
      }, {
        key: "onClick",
        value: function onClick() {
          console.log(this.wizard.currentStepIndex); // console.log(this.wizard.currentStep);
        ...
        key: "details",
        value: function details(requests) {
        ...
        key: "getAllRequest",
        value: function getAllRequest(filter, providerId, userId, patientIds, requestStatusIds, sorting, skipCount, maxResultCount) {
          var _this = this;

          this._loadCtrl.present();

          this._Request.getAll(filter, providerId, userId, patientIds, requestStatusIds, sorting, skipCount, maxResultCount).subscribe(function (request) {
            _this.requests = request.result.items;
            console.log(request);

            _this._loadCtrl.dismiss();
          });
        }
      }, {
        key: "evaluation",
        value: function evaluation(request) {
                  ...
                  case 5:
                    ...
                    return modal.onWillDismiss().then(function (data) {
                      ...
                      if (data.data.patient_id) {
                        ...
                        _this2.requests = undefined;

                        _this2.getAllRequest(undefined, undefined, _this2.userId, patient_ids, undefined, undefined, undefined, undefined);
                      }
                    });
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('Wizard', {
      "static": false
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", angular_archwizard__WEBPACK_IMPORTED_MODULE_2__["WizardComponent"])], Tab4Page.prototype, "wizard", void 0);
    Tab4Page = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/tabs/Request/tab4.page.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./tab4.page.scss */
      "./src/app/tabs/Request/tab4.page.scss"))["default"]]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], src_app_services_MainRequest_mainRequest__WEBPACK_IMPORTED_MODULE_4__["MainRequestService"], src_app_services_loading_loading_service__WEBPACK_IMPORTED_MODULE_5__["LoadingService"], src_app_services_DataShare_data_share_service__WEBPACK_IMPORTED_MODULE_6__["DataShareService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_7__["ModalController"]])], Tab4Page);
    /***/
  }
}]);
//# sourceMappingURL=Request-tab4-module-es5.js.map