...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["login-verification-code-login-verification-code-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppLoginVerificationCodeLoginVerificationCodePageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppLoginVerificationCodeLoginVerificationCodeModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "LoginVerificationCodePageModule", function () {
      return LoginVerificationCodePageModule;
    });
    /* harmony import */
    ...
    var _login_verification_code_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./login-verification-code.page */
    ...
    var LoginVerificationCodePageModule = function LoginVerificationCodePageModule() {
      _classCallCheck(this, LoginVerificationCodePageModule);
    };

    LoginVerificationCodePageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["IonicModule"], // TokenService
      _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"].forChild(routes), _ngx_translate_core__WEBPACK_IMPORTED_MODULE_7__["TranslateModule"].forChild()],
  ...
  /***/
  function srcAppLoginVerificationCodeLoginVerificationCodePageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppLoginVerificationCodeLoginVerificationCodePageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "LoginVerificationCodePage", function () {
      return LoginVerificationCodePage;
    });
    /* harmony import */
    ...
    var _services_login_login__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../services/login/login */
    "./src/app/services/login/login.ts");
    /* harmony import */


    var _models_AuthenticateModel__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../models/AuthenticateModel */
    ...
    var _services_Settings_Settings__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ../services/Settings/Settings */
    "./src/app/services/Settings/Settings.ts");
    /* harmony import */


    var _services_TempDataDistributor_TempDataDistributor__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ../services/TempDataDistributor/TempDataDistributor */
    "./src/app/services/TempDataDistributor/TempDataDistributor.ts");

    var LoginVerificationCodePage = /*#__PURE__*/function () {
      function LoginVerificationCodePage(_login, activeRouter, router, storage, _loading, _translate, _setting, _tempData // private _tokenService: TokenService
      ) {
        _classCallCheck(this, LoginVerificationCodePage);
      ...
      _createClass(LoginVerificationCodePage, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          if (this.activeRouter.snapshot.data['dataSharing']) {
            this.UserName = this.activeRouter.snapshot.data['dataSharing']; // this.vCode = this.activeRouter.snapshot.data['dataSharing'].verificationCode;
        ...
        value: function LoginOk() {
          ...
          var userInfoForLogin = new _models_AuthenticateModel__WEBPACK_IMPORTED_MODULE_3__["AuthenticateModel"](modelResult); //send Info for Login...

          this._login.authenticate(userInfoForLogin).subscribe(function (result) {
            _this.getCurrentUserLanguage();

            setTimeout(function () {
              _this._loading.dismiss();

              _this.processAuthenticateResult(result.result, result.result.returnUrl); // process Authenticate Result
        ...
        value: function processAuthenticateResult(authenticateResult, redirectUrl) {
        ...
        key: "login",
        value: function login(accessToken, encryptedAccessToken, expireInSeconds, rememberMe, twoFactorRememberClientToken, redirectUrl) {
          ...
          if (redirectUrl) {
            ...
            window.localStorage.setItem('lang', this.currentLang); //location.href = redirectUrl;
        ...
        value: function getCurrentUserLanguage() {
          ...
          this._setting.getCurrentUserLanguage().subscribe(function (lang) {
            _this2.currentLang = lang.result;
            console.log(_this2.currentLang);
          });
        }
      }, {
        key: "changeC1",
        value: function changeC1(e) {
          console.log(e.data); //this.C1 = e.data

          if (parseInt(e.data) >= 0 && parseInt(e.data) <= 9) document.getElementById("VC2").focus();
        }
      }, {
        key: "changeC2",
        value: function changeC2(e) {
          console.log(e.data); //  this.C2 = e.data

          if (parseInt(e.data) >= 0 && parseInt(e.data) <= 9) document.getElementById("VC3").focus();
        }
      }, {
        key: "changeC3",
        value: function changeC3(e) {
          console.log(e.data); // this.C3 = e.data

          if (parseInt(e.data) >= 0 && parseInt(e.data) <= 9) document.getElementById("VC4").focus();
        }
      }, {
        key: "changeC4",
        value: function changeC4(e) {
          console.log(e.data); //  this.C4 = e.data

          if (parseInt(e.data) >= 0 && parseInt(e.data) <= 9) document.getElementById("VC5").focus();
        }
      }, {
        key: "changeC5",
        value: function changeC5(e) {
          console.log(e.data); // this.C5 = e.data

          if (parseInt(e.data) >= 0 && parseInt(e.data) <= 9) document.getElementById("VC6").focus();
        }
      }, {
        key: "changeC6",
        value: function changeC6(e) {
          console.log(e.data); //  this.C6 = e.data
    ...
    LoginVerificationCodePage.ctorParameters = function () {
      return [{
    ...
    LoginVerificationCodePage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-login-verification-code',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./login-verification-code.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/login-verification-code/login-verification-code.page.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./login-verification-code.page.scss */
      "./src/app/login-verification-code/login-verification-code.page.scss"))["default"]]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_login_login__WEBPACK_IMPORTED_MODULE_2__["LoginService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"], _ionic_storage__WEBPACK_IMPORTED_MODULE_5__["Storage"], _services_loading_loading_service__WEBPACK_IMPORTED_MODULE_6__["LoadingService"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_7__["TranslateService"], _services_Settings_Settings__WEBPACK_IMPORTED_MODULE_8__["SettingsService"], _services_TempDataDistributor_TempDataDistributor__WEBPACK_IMPORTED_MODULE_9__["TempDataDistributorService"] // private _tokenService: TokenService
  ...
  /***/
  function srcAppModelsAuthenticateModelTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var AuthenticateModel = function AuthenticateModel(authenticateModel) {
      ...
      _createClass(AuthenticateResultModel, [{
        ...
        value: function init(data) {
          if (data) {
            ...
            if (data["twoFactorAuthProviders"] && data["twoFactorAuthProviders"].constructor === Array) {
              ...
              var _iterator = _createForOfIteratorHelper(data["twoFactorAuthProviders"]),
                  _step;
        ...
        value: function toJSON(data) {
          ...
          if (this.twoFactorAuthProviders && this.twoFactorAuthProviders.constructor === Array) {
            ...
            var _iterator2 = _createForOfIteratorHelper(this.twoFactorAuthProviders),
                _step2;
...
//# sourceMappingURL=login-verification-code-login-verification-code-module-es5.js.map