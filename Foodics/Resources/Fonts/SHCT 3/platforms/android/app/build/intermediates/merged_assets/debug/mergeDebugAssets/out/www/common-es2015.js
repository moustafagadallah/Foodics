...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LookUps", function() { return LookUps; });
...
let LookUps = class LookUps {
    constructor(http) {
        this.http = http;
    }
    getAllNationalities() {
        let url_ = src_app_enums_baseUrl__WEBPACK_IMPORTED_MODULE_3__["BaseUrl"].baseUrl + "/api/services/app/CommonLookup/GetAllNationalities";
        return this.http.get(url_);
    }
    getAllCountries() {
        let url_ = src_app_enums_baseUrl__WEBPACK_IMPORTED_MODULE_3__["BaseUrl"].baseUrl + "/api/services/app/CommonLookup/GetAllCountries";
        return this.http.get(url_);
    }
    getAllRegions(filter, ParentId) {
        let url_ = src_app_enums_baseUrl__WEBPACK_IMPORTED_MODULE_3__["BaseUrl"].baseUrl + "/api/services/app/CommonLookup/GetAllRegions?";
        if (filter !== undefined)
    ...
    getAllCities(filter, ParentId) {
        let url_ = src_app_enums_baseUrl__WEBPACK_IMPORTED_MODULE_3__["BaseUrl"].baseUrl + "/api/services/app/CommonLookup/GetAllCities?";
        if (filter !== undefined)
            url_ += "Filter=" + encodeURIComponent("" + filter) + "&";
        if (ParentId !== undefined)
            url_ += "ParentId=" + encodeURIComponent("" + ParentId) + "&";
    ...
    getAllDistricts(filter, ParentId) {
        let url_ = src_app_enums_baseUrl__WEBPACK_IMPORTED_MODULE_3__["BaseUrl"].baseUrl + "/api/services/app/CommonLookup/GetAllDistricts?";
        if (filter !== undefined)
            url_ += "Filter=" + encodeURIComponent("" + filter) + "&";
        if (ParentId !== undefined)
            url_ += "ParentId=" + encodeURIComponent("" + ParentId) + "&";
    ...
    /**
      * @return Success
      */
    getLookupsForDropDown(lookupTypeEnum) {
        let url_ = src_app_enums_baseUrl__WEBPACK_IMPORTED_MODULE_3__["BaseUrl"].baseUrl + "/api/services/app/CommonLookup/GetLookupsForDropDown?";
        if (lookupTypeEnum === undefined || lookupTypeEnum === null)
            throw new Error("The parameter 'lookupTypeEnum' must be defined and cannot be null.");
        else
            url_ += "lookupTypeEnum=" + encodeURIComponent("" + 13) + "&";
        url_ = url_.replace(/[?&]$/, "");
        return this.http.get(url_);
    }
    getPatientRelation(lookupTypeEnum) {
        let url_ = src_app_enums_baseUrl__WEBPACK_IMPORTED_MODULE_3__["BaseUrl"].baseUrl + "/api/services/app/CommonLookup/GetLookupsForDropDown?";
        if (lookupTypeEnum !== undefined)
            url_ += "lookupTypeEnum=" + encodeURIComponent("" + lookupTypeEnum) + "&";
        url_ = url_.replace(/[?&]$/, "");
        return this.http.get(url_);
    }
};
LookUps.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
LookUps = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MainMedicalService", function() { return MainMedicalService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
/* harmony import */ var src_app_enums_baseUrl__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/enums/baseUrl */ "./src/app/enums/baseUrl.ts");
...
let MainMedicalService = class MainMedicalService {
    constructor(http) {
        this.http = http;
    }
    /**
     ...
     * @return Success
     */
    getAllMainMedical(serviceType, filter, AdditionalParameter) {
        let url_ = src_app_enums_baseUrl__WEBPACK_IMPORTED_MODULE_3__["BaseUrl"].baseUrl + "/api/services/app/MainMedicalServices/GetAll?";
...
MainMedicalService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
MainMedicalService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]])
...
let RequestService = class RequestService {
     ...
     * @return Success
     */
    getRequestServices(filter, requestId) {
        let url_ = src_app_enums_baseUrl__WEBPACK_IMPORTED_MODULE_3__["BaseUrl"].baseUrl + "/api/services/app/Request/GetRequestServices?";
        if (filter !== undefined)
            url_ += "Filter=" + encodeURIComponent("" + filter) + "&";
 ...
 * @return Success
 */
    createOrEditRequest(input) {
        let url_ = src_app_enums_baseUrl__WEBPACK_IMPORTED_MODULE_3__["BaseUrl"].baseUrl + "/api/services/app/Request/CreateOrEditRequest";
        url_ = url_.replace(/[?&]$/, "");
