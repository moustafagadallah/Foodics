...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-get-in-touch-get-in-touch-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesGetInTouchGetInTouchPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppModelsContactUsDtoTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ContactUsDto", function () {
      return ContactUsDto;
    });
    /* harmony import */
    ...
    var ContactUsDto = function ContactUsDto(data) {
  ...
  /***/
  function srcAppPagesGetInTouchGetInTouchModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "GetInTouchPageModule", function () {
    ...
    var _get_in_touch_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./get-in-touch.page */
    ...
    var GetInTouchPageModule = function GetInTouchPageModule() {
      _classCallCheck(this, GetInTouchPageModule);
    };

    GetInTouchPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppPagesGetInTouchGetInTouchPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesGetInTouchGetInTouchPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "GetInTouchPage", function () {
    ...
    var src_app_services_ContactUs_ContactUs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! src/app/services/ContactUs/ContactUs */
    ...
    var src_app_models_ContactUsDto__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! src/app/models/ContactUsDto */
    "./src/app/models/ContactUsDto.ts");
    /* harmony import */
    ...
    var GetInTouchPage = /*#__PURE__*/function () {
      function GetInTouchPage(_inTouch, alertctrl, _loading) {
        _classCallCheck(this, GetInTouchPage);
      ...
      _createClass(GetInTouchPage, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }, {
        key: "getInTouch",
        value: function getInTouch() {
          var _this = this;
          ...
          var contact = new src_app_models_ContactUsDto__WEBPACK_IMPORTED_MODULE_4__["ContactUsDto"](this.contactUs);

          this._inTouch.create(contact).subscribe(function (data) {
            console.log(data);
            setTimeout(function () {
              _this._loading.dismiss().then(function () {
                _this.presentAlert("Your complaint has been sent successfully");
              });
            }, 1500);
          }, function (error) {
        ...
        key: "fileAttach",
        value: function fileAttach(files) {
          var _this3 = this;
          ...
          reader.onload = function (_event) {
            _this3.attachmentUrl = reader.result;
            console.log(_this3.attachmentUrl);
          };
        }
      }]);
    ...
    GetInTouchPage.ctorParameters = function () {
      return [{
    ...
    GetInTouchPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-get-in-touch',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./get-in-touch.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/get-in-touch/get-in-touch.page.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./get-in-touch.page.scss */
      "./src/app/pages/get-in-touch/get-in-touch.page.scss"))["default"]]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_app_services_ContactUs_ContactUs__WEBPACK_IMPORTED_MODULE_2__["ContactUsService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["AlertController"], src_app_services_loading_loading_service__WEBPACK_IMPORTED_MODULE_5__["LoadingService"]])], GetInTouchPage);
    /***/
  },
  ...
  /***/
  function srcAppServicesContactUsContactUsTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var ContactUsService = /*#__PURE__*/function () {
      ...
      _createClass(ContactUsService, [{
        ...
        value: function create(input) {
          var url_ = src_app_enums_baseUrl__WEBPACK_IMPORTED_MODULE_3__["BaseUrl"].baseUrl + "/api/services/app/ContactUs/Create";
          url_ = url_.replace(/[?&]$/, "");
    ...
    ContactUsService.ctorParameters = function () {
      return [{
    ...
    ContactUsService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]])], ContactUsService);
    /***/
  }
}]);
//# sourceMappingURL=pages-get-in-touch-get-in-touch-module-es5.js.map