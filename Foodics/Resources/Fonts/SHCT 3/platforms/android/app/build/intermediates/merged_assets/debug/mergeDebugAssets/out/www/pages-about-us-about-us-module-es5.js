...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-about-us-about-us-module"], {
  ...
  function srcAppPagesAboutUsAboutUsPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AboutUsPage = /*#__PURE__*/function () {
      function AboutUsPage(_settings) {
      ...
      _createClass(AboutUsPage, [{
        ...
        value: function getInfo() {
          ...
          this._settings.getAllSettings().subscribe(function (data) {
            _this.aboutCompany = data.result.general.aboutCompany;
            _this.phone = data.result.general.phone;
            _this.email = data.result.general.email;
            _this.website = data.result.general.website;
            console.log(data);
          });
        }
      }]);
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_app_services_Settings_Settings__WEBPACK_IMPORTED_MODULE_2__["SettingsService"]])], AboutUsPage);
    /***/
  }
}]);
