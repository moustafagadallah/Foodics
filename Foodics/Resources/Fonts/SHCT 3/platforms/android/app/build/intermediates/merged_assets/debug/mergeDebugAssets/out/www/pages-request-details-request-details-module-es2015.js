...
/* harmony import */ var _request_details_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./request-details.page */ "./src/app/pages/request-details/request-details.page.ts");
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var src_app_services_Request_View__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/services/Request/View */ "./src/app/services/Request/View.ts");
/* harmony import */ var src_app_services_Request_TeamWork__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/services/Request/TeamWork */ "./src/app/services/Request/TeamWork.ts");
/* harmony import */ var src_app_services_Request_RequestServices__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/services/Request/RequestServices */ "./src/app/services/Request/RequestServices.ts");
/* harmony import */ var src_app_services_Request_RequestActions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/services/Request/RequestActions */ "./src/app/services/Request/RequestActions.ts");
/* harmony import */ var src_app_services_Request_RequestDiagnosis__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/services/Request/RequestDiagnosis */ "./src/app/services/Request/RequestDiagnosis.ts");
/* harmony import */ var src_app_services_Request_RequestMedicine__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/services/Request/RequestMedicine */ "./src/app/services/Request/RequestMedicine.ts");
/* harmony import */ var src_app_services_Request_HealthyRecommendati__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/app/services/Request/HealthyRecommendati */ "./src/app/services/Request/HealthyRecommendati.ts");
/* harmony import */ var src_app_services_loading_loading_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/app/services/loading/loading.service */ "./src/app/services/loading/loading.service.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var src_app_services_DataShare_data_share_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! src/app/services/DataShare/data-share.service */ "./src/app/services/DataShare/data-share.service.ts");
...
let RequestDetailsPage = class RequestDetailsPage {
    constructor(_view, _teamWork, _Request, _actions, _diagnosis, _medicine, _healthy, _loadCtrl, activeRouter, _dataShare) {
        this._view = _view;
    ...
    ionViewWillEnter() {
        this.initialSetting();
        setTimeout(() => {
            this.getView(this.request_id);
            this.getTeamWork(undefined, this.request_id, undefined, undefined, undefined);
            this.getDiagnosis(undefined, this.request_id, undefined, undefined, undefined);
            this.getMedicine(undefined, this.request_id, undefined, undefined, undefined);
            this.getHealthyRecommendation(undefined, this.request_id, undefined, undefined, undefined);
            this.getRequestService(undefined, this.request_id);
            this.getActions(this.request_id);
        }, 2000);
    }
    initialSetting() {
    ...
    getView(requestId) {
        this._view.getRequestForView(requestId).subscribe(view => {
            this.spinnerSiew = false;
            this.view = view.result;
            this.viewNotes = view.result.evaluationComment;
            this.vitaSignNotes = view.result.vitaSignNotes;
            console.log(this.view);
        }, error => { console.log(error); this.spinnerSiew = false; });
    }
    getTeamWork(filter, requestId, sorting, skipCount, maxResultCount) {
        this._teamWork.getRequestTeamWork(filter, requestId, sorting, skipCount, maxResultCount).subscribe(team => {
            this.teamWork = team.result.items;
            console.log(this.teamWork);
        }, error => console.log(error));
    }
    getRequestService(filter, requestId) {
        this._Request.getRequestServices(filter, requestId).subscribe(req => {
            this.request = req.result;
            console.log(this.request);
        }, error => console.log(error));
    }
    getActions(requestId) {
        this._actions.getRequestActions(requestId).subscribe(actions => {
            this.action = actions;
            console.log(this.action);
        }, error => console.log(error));
    }
    getDiagnosis(filter, requestId, sorting, skipCount, maxResultCount) {
        this._diagnosis.getRequestDiagnosis(filter, requestId, sorting, skipCount, maxResultCount).subscribe(diagnosis => {
            this.diagnosis = diagnosis.result.items;
            console.log(this.diagnosis);
        }, error => console.log(error));
    }
    getMedicine(filter, requestId, sorting, skipCount, maxResultCount) {
        this._medicine.getRequestMedicine(filter, requestId, sorting, skipCount, maxResultCount).subscribe(mediciene => {
            this.medicine = mediciene.result.items;
            console.log(this.medicine);
        }, error => console.log(error));
    }
    getHealthyRecommendation(filter, requestId, sorting, skipCount, maxResultCount) {
        this._healthy.getRequestHealthyRecommendation(filter, requestId, sorting, skipCount, maxResultCount).subscribe(healthy => {
            this.healthy = healthy.result.items;
...
RequestDetailsPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./request-details.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/request-details/request-details.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./request-details.page.scss */ "./src/app/pages/request-details/request-details.page.scss")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_app_services_Request_View__WEBPACK_IMPORTED_MODULE_2__["ViewService"],
        src_app_services_Request_TeamWork__WEBPACK_IMPORTED_MODULE_3__["TeamWorkService"],
        src_app_services_Request_RequestServices__WEBPACK_IMPORTED_MODULE_4__["RequestService"],
        src_app_services_Request_RequestActions__WEBPACK_IMPORTED_MODULE_5__["ActionsService"],
        src_app_services_Request_RequestDiagnosis__WEBPACK_IMPORTED_MODULE_6__["DiagnosisService"],
        src_app_services_Request_RequestMedicine__WEBPACK_IMPORTED_MODULE_7__["MedicineService"],
        src_app_services_Request_HealthyRecommendati__WEBPACK_IMPORTED_MODULE_8__["HealthyRecommendationService"],
        src_app_services_loading_loading_service__WEBPACK_IMPORTED_MODULE_9__["LoadingService"],
        _angular_router__WEBPACK_IMPORTED_MODULE_10__["ActivatedRoute"],
        src_app_services_DataShare_data_share_service__WEBPACK_IMPORTED_MODULE_11__["DataShareService"]])
], RequestDetailsPage);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HealthyRecommendationService", function() { return HealthyRecommendationService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
let HealthyRecommendationService = class HealthyRecommendationService {
    constructor(http) {
        this.http = http;
    }
    /**
     ...
     * @return Success
     */
    getRequestHealthyRecommendation(filter, requestId, sorting, skipCount, maxResultCount) {
        let url_ = src_app_enums_baseUrl__WEBPACK_IMPORTED_MODULE_3__["BaseUrl"].baseUrl + "/api/services/app/Request/GetRequestHealthyRecommendation?";
        if (filter !== undefined)
...
HealthyRecommendationService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
HealthyRecommendationService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]])
], HealthyRecommendationService);
...
let ActionsService = class ActionsService {
    ...
    getRequestActions(requestId) {
        let url_ = src_app_enums_baseUrl__WEBPACK_IMPORTED_MODULE_3__["BaseUrl"].baseUrl + "/api/services/app/Request/GetRequestActions?";
        if (requestId !== undefined)
            url_ += "requestId=" + encodeURIComponent("" + requestId) + "&";
        url_ = url_.replace(/[?&]$/, "");
        return this.http.get(url_);
...
let DiagnosisService = class DiagnosisService {
     ...
     * @return Success
     */
    getRequestDiagnosis(filter, requestId, sorting, skipCount, maxResultCount) {
        let url_ = src_app_enums_baseUrl__WEBPACK_IMPORTED_MODULE_3__["BaseUrl"].baseUrl + "/api/services/app/Request/GetRequestDiagnosis?";
        if (filter !== undefined)
            url_ += "Filter=" + encodeURIComponent("" + filter) + "&";
        if (requestId !== undefined)
            url_ += "RequestId=" + encodeURIComponent("" + requestId) + "&";
...
let MedicineService = class MedicineService {
    ...
    /**
         ...
         * @return Success
         */
    getRequestMedicine(filter, requestId, sorting, skipCount, maxResultCount) {
        let url_ = src_app_enums_baseUrl__WEBPACK_IMPORTED_MODULE_3__["BaseUrl"].baseUrl + "/api/services/app/Request/GetRequestMedicine?";
        if (filter !== undefined)
            url_ += "Filter=" + encodeURIComponent("" + filter) + "&";
        if (requestId !== undefined)
            url_ += "RequestId=" + encodeURIComponent("" + requestId) + "&";
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TeamWorkService", function() { return TeamWorkService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
/* harmony import */ var src_app_enums_baseUrl__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/enums/baseUrl */ "./src/app/enums/baseUrl.ts");
...
let TeamWorkService = class TeamWorkService {
    constructor(http) {
        this.http = http;
    }
    /**
     ...
     * @return Success
     */
    getRequestTeamWork(filter, requestId, sorting, skipCount, maxResultCount) {
        let url_ = src_app_enums_baseUrl__WEBPACK_IMPORTED_MODULE_3__["BaseUrl"].baseUrl + "/api/services/app/Request/GetRequestTeamWork?";
        if (filter !== undefined)
            url_ += "Filter=" + encodeURIComponent("" + filter) + "&";
        if (requestId !== undefined)
            url_ += "RequestId=" + encodeURIComponent("" + requestId) + "&";
...
TeamWorkService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
TeamWorkService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]])
...
let ViewService = class ViewService {
     ...
     * @return Success
     */
    getRequestForView(id) {
        let url_ = src_app_enums_baseUrl__WEBPACK_IMPORTED_MODULE_3__["BaseUrl"].baseUrl + "/api/services/app/Request/GetRequestForView?";
        if (id !== undefined)
...
//# sourceMappingURL=pages-request-details-request-details-module-es2015.js.map