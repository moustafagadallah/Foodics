...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ProvidedServicesPageModule", function() { return ProvidedServicesPageModule; });
...
/* harmony import */ var _provided_services_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./provided-services.page */ "./src/app/pages/userService/serviceProviders/provided-services/provided-services.page.ts");
...
let ProvidedServicesPageModule = class ProvidedServicesPageModule {
};
ProvidedServicesPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ProvidedServicesPage", function() { return ProvidedServicesPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var src_app_services_ProvidedServices_provided_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/services/ProvidedServices/provided.service */ "./src/app/services/ProvidedServices/provided.service.ts");
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var src_app_services_DataShare_data_share_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/services/DataShare/data-share.service */ "./src/app/services/DataShare/data-share.service.ts");
...
let ProvidedServicesPage = class ProvidedServicesPage {
    constructor(_providedService, _Loading, activeRouter, _dataShare, router, navctrl, _tempData, modalController) {
    ...
    initialSetting() {
        ...
        console.log(this.mainMedicalServiceData);
        ...
        if (this.activeRouter.snapshot.data["dataSharing"]) {
            let R = this.activeRouter.snapshot.data['dataSharing'];
            console.log(R);
    ...
    getProvidedService(minPrice, maxPrice, filter) {
        //this._Loading.present();
        this.spinnerShow = true;
        this._providedService
            .getProvidedServices(this.tenantId, undefined, this.mainService_id, minPrice, maxPrice, undefined, filter, window.localStorage.getItem('lang'))
            .subscribe((data) => {
            console.log(data);
            data.result.items.forEach(element => {
                this.providedServices.push(element);
            });
            // this._Loading.dismiss();
            this.spinnerShow = false;
            console.log(this.providedServices);
            this.providedServicesName = this.providedServices[0].providerName;
        }, error => {
            this.spinnerShow = false;
            console.log(error);
        });
    ...
    navigateProviderDetails(providedService) {
        this._dataShare.setData("providerDetails", providedService);
        console.log(providedService);
        if (!this.isAuthenticated)
            this.nextPage = 'login';
        else
            this.nextPage = "tabs/provided-details/providerDetails";
    ...
    filterModal() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            yield modal.onWillDismiss().then((data) => {
                ...
                let minPrice = data.data.price ? data.data.price.minPrice : undefined;
                let maxPrice = data.data.price ? data.data.price.maxPrice : undefined;
                let description = data.data.searchList ? data.data.searchList.description : undefined;
                if (data.data.searchList || data.data.price) {
                    this.providedServices = [];
                    this.getProvidedService(minPrice, maxPrice, description);
                }
            });
        });
    }
};
ProvidedServicesPage.ctorParameters = () => [
...
ProvidedServicesPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-provided-services',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./provided-services.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/userService/serviceProviders/provided-services/provided-services.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./provided-services.page.scss */ "./src/app/pages/userService/serviceProviders/provided-services/provided-services.page.scss")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_app_services_ProvidedServices_provided_service__WEBPACK_IMPORTED_MODULE_2__["ProvidedService"],
        src_app_services_loading_loading_service__WEBPACK_IMPORTED_MODULE_3__["LoadingService"],
        _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"],
        src_app_services_DataShare_data_share_service__WEBPACK_IMPORTED_MODULE_5__["DataShareService"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ProvidedService", function() { return ProvidedService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
let ProvidedService = class ProvidedService {
     ...
     * @return Success
     */
    getProvidedServices(tenantId, classificationId, mainMedicalService, minPrice, maxPrice, hasOffer, Filter, AdditionalParameter) {
        let url_ = src_app_enums_baseUrl__WEBPACK_IMPORTED_MODULE_2__["BaseUrl"].baseUrl + "/api/services/app/Request/GetProvidedServices?";
        if (tenantId !== undefined)
            url_ += "TenantId=" + encodeURIComponent("" + tenantId) + "&";
        if (classificationId !== undefined)
            url_ += "ClassificationId=" + encodeURIComponent("" + classificationId) + "&";
        if (mainMedicalService !== undefined)
            url_ += "MainMedicalService=" + encodeURIComponent("" + mainMedicalService) + "&";
        ...
        if (AdditionalParameter !== undefined)
            url_ += "AdditionalParameter.Language=" + encodeURIComponent("" + AdditionalParameter) + "&";
        url_ = url_.replace(/[?&]$/, "");
        return this.http.get(url_);
    }
};
ProvidedService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] }
];
ProvidedService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
//# sourceMappingURL=pages-userService-serviceProviders-provided-services-provided-services-module-es2015.js.map